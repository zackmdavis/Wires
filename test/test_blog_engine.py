...
class TestComments(unittest.TestCase):
    ...
    def test_can_make_comment(self):
        ...
        stamp = str(binascii.b2a_hex(os.urandom(4)), encoding="utf-8")
        name_field = self.driver.find_element_by_id("comment_author")
        name_field.send_keys("Test Commenter {0}".format(stamp))
        email_field = self.driver.find_element_by_id("comment_email")
        email_field.send_keys("test@example.com")
        comment_field = self.driver.find_element_by_id("comment_body")
